...
# def update_status():
#     """更新状态信息"""
#     global current_keys, current_cat_breed, current_confidence
#     while True:
#         current_keys = keyboard_controller.get_active_keys()
...
#     """启动后台任务"""
#     # 启动键盘控制
#     kb_thread = threading.Thread(target=keyboard_controller.run, daemon=True)
#     kb_thread.start()
